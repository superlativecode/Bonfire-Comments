...
class Migration_Install_comments_permissions extends Migration
{
	...
	private $permission_values = array(
		array(
			'name' => 'Comments.Content.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Comments.Content.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Comments.Content.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Comments.Content.Delete',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Comments.Reports.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Comments.Reports.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Comments.Reports.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Comments.Reports.Delete',
			'description' => '',
			'status' => 'active',
		),
	);
