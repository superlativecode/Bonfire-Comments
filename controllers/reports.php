...
class reports extends Admin_Controller
{
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Comments.Reports.View');
	...
	{
		$this->auth->restrict('Comments.Reports.Create');
		...
		if (isset($_POST['save']))
		{
			if ($insert_id = $this->save_comments())
			{
				...
				redirect(SITE_AREA .'/reports/comments');
			}
			else
			{
	...
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('Comments.Reports.Edit');
		...
		{
			$this->auth->restrict('Comments.Reports.Delete');
